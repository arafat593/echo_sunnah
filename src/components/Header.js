                    ...
                    <div>
                      ...
                      {userProfileOpen && (
                        <div className="absolute right-0 mt-4.5 w-60 bg-white rounded-3xl shadow-[0_20px_50px_rgba(4,78,56,0.15)] border border-emerald-500/10 py-3 z-50 animate-fadeIn">
                          <div className="block px-4 py-2 pb-3 border-b border-slate-100">
                          ...
                          <div className="p-1 space-y-0.5 mt-1">
                            <Link href="/profile" onClick={() => setUserProfileOpen(false)} className="flex items-center gap-2.5 px-3 py-2.5 text-xs font-bold text-slate-700 hover:bg-emerald-50/60 hover:text-emerald-800 rounded-2xl transition-all">
