...
function PhoneCodeSelect({ value, iso2, onChange }) {
  ...
  return (
    <div className="relative shrink-0" ref={containerRef}>
      ...
      {isOpen && (
        <div className="absolute left-0 mt-1.5 bg-white border border-slate-100 rounded-2xl shadow-xl z-50 py-1.5 animate-fadeIn w-[260px] max-h-[300px] flex flex-col font-sans">
